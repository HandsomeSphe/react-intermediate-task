...
2. When the user starts typing in the search bar, a dropdown should appear with suggestions for cities that match what the user has typed so far (You can use the endpoint: `http://localhost:3004/cities?name_like=${SearchTerm}`).
